...
| `INFURA_API_KEY`                             | Required. No default.                                           | The infura API key to connect with the blockchain network. |
| `DATABASE_USER_NAME`                             | Required. No default.                                           | The username to connect to the PostgreSQL database. |
| `DATABASE_USER_PASSWORD`                             | Required. No default.                                           | The password to connect to the PostgreSQL database. |
| `DATABASE_NAME`                             | Required. No default.                                           | The PostgreSQL database name where all data is stored. |
